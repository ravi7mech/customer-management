...
/**
 * Criteria class for the {@link com.apptium.customer.domain.IndActivation} entity. This class is used
 * in {@link com.apptium.customer.web.rest.IndActivationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ind-activations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class IndActivationCriteria implements Serializable, Criteria {
    ...
    public IndActivationCriteria() {}

    public IndActivationCriteria(IndActivationCriteria other) {
    ...
    @Override
    public IndActivationCriteria copy() {
        return new IndActivationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IndActivationCriteria that = (IndActivationCriteria) o;
        return (
