...
/**
 * Criteria class for the {@link com.apptium.customer.domain.IndContactChar} entity. This class is used
 * in {@link com.apptium.customer.web.rest.IndContactCharResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ind-contact-chars?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class IndContactCharCriteria implements Serializable, Criteria {
    ...
    private LongFilter svContactId;

    private BooleanFilter isEmailValid;

    private BooleanFilter isAddressValid;

    private LongFilter indConId;

    private LongFilter indContactId;

    public IndContactCharCriteria() {}

    public IndContactCharCriteria(IndContactCharCriteria other) {
        ...
        this.indConId = other.indConId == null ? null : other.indConId.copy();
        this.indContactId = other.indContactId == null ? null : other.indContactId.copy();
    }

    @Override
    public IndContactCharCriteria copy() {
        return new IndContactCharCriteria(this);
    }
    ...
    public LongFilter getSvContactId() {
        return svContactId;
    }

    public LongFilter svContactId() {
        if (svContactId == null) {
            svContactId = new LongFilter();
        }
        return svContactId;
    }

    public void setSvContactId(LongFilter svContactId) {
    ...
    public LongFilter getIndConId() {
        return indConId;
    }

    public LongFilter indConId() {
        if (indConId == null) {
            indConId = new LongFilter();
        }
        return indConId;
    }

    public void setIndConId(LongFilter indConId) {
    ...
    public boolean equals(Object o) {
        ...
        final IndContactCharCriteria that = (IndContactCharCriteria) o;
        return (
            ...
            Objects.equals(indConId, that.indConId) &&
    ...
    public String toString() {
        return "IndContactCharCriteria{" +
            ...
            (indConId != null ? "indConId=" + indConId + ", " : "") +
